# Generated by Django 5.1.4 on 2025-02-06 09:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicinetype_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.medicinetype')),
                ('size_objects', models.ManyToManyField(related_name='sizes', to='store.size')),
                ('unit_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='units', to='store.unit_type')),
            ],
            bases=('store.basemodel',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.product')),
                ('size_object', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='store.size')),
                ('unit_object', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='store.unit_type')),
            ],
            bases=('store.basemodel',),
        ),
    ]
